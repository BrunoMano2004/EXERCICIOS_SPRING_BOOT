...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoAdocaoDTO dto) throws MessagingException {
    ...
    public void aprovar(AprovacaoAdocaoDTO dto) throws MessagingException {
    ...
    public void reprovar(ReprovacaoAdocaoDTO dto) throws MessagingException {
        Adocao adocao = adocaoRepository.getReferenceById(dto.idAdocao());
        adocao.marcarComoReprovado(dto);
